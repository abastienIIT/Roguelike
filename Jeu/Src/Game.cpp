...
void Game::init(const char* title, int xpos, int ypos, int width, int height, bool fullscreen, int channels)
{
	...
	globalbilboulga->getAssetManager()->addAnimatedTexture("player", "assets/Player/PlayerBot.png", "assets/Player/PlayerInfos.txt");
	globalbilboulga->getAssetManager()->addTexture("player", "assets/Player/PlayerTop.png");
	globalbilboulga->getAssetManager()->addAnimatedTexture("playerTop", "assets/Player/PlayerTop/PlayerTop.png", "assets/Player/PlayerTop/PlayerInfos.txt");
	globalbilboulga->getAssetManager()->addAnimatedTexture("playerBot", "assets/Player/PlayerBot/PlayerBot.png", "assets/Player/PlayerBot/PlayerInfos.txt");
